...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://stg-api.stackbit.com/pull/60376828b45efb0016f418b3
...
To start editing your site, you can use the Sanity interface at https://hs-76828.sanity.studio/.
...
Generated at `2021-02-25T09:05:20.150Z` by Stackbit version `0.3.50`.